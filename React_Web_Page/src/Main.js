            ...
            <div class="consulting">
              <div class="consulting-list">
                <div class="consulting-wrap">
                  ...
                  <div class="consulting-text">채팅상담에 대한 내용입니다.</div>
                </div>
                <div class="consulting-wrap">
                  <div class="consulting-btn-icons">
                    <Link to={"/videoconsulting"} class="cbtn">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        class="consulting-icons"
                  ...
                  <div class="consulting-text">영상상담에 대한 내용입니다.</div>
                </div>
                <div class="consulting-wrap">
                  <div class="consulting-btn-icons">
                    <Link to={"/consulting"} class="cbtn">
                  ...
                  <div class="consulting-text">챗봇상담에 대한 내용입니다.</div>
                </div>
                <div class="consulting-wrap">
                  <div class="consulting-btn-icons">
                    <Link to={"/consulting"} class="cbtn">
                  ...
                  <div class="consulting-text">AI상담에 대한 내용입니다.</div>
                </div>
              </div>
            </div>
          </div>
